...
async function verify() {
    console.log('Verifying science question insertion (Batch 11)...');
    ...
    console.log(`Total Science Questions: ${scienceCount}`);

    // 3. Check for the new chapters
    const chapters = ['Light: Mirrors and Lenses', 'How Nature Works in Harmony'];
    ...
    for (const chapter of chapters) {
        ...
        if (chError) {
            ...
            console.log(`Questions in chapter "${chapter}": ${chCount}`);
        }
    }
}
