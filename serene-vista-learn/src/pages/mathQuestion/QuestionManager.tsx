    ...
    <div className="max-w-7xl mx-auto p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-2">Manage math questions assigned to different classes</p>
        </div>
        <Link to="/admin/dashboard/math-question-assigner">
      ...
      {/* ...rest is same as science version but wired to mathApi... */}
      {/* For brevity reuse the same UI markup as science manager - unchanged below */}
      <Card>
        <CardHeader>
