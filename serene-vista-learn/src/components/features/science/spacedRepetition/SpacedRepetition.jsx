...
import { useSubmitRatingsMutation, useAddPointsMutation  } from '../../../../state/api/scienceApi.ts';
...
const SpacedRepetition = () => {
  ...
  const words = useSelector(state => state.science.words);
  console.log("Words for Science Repetition:", words);
